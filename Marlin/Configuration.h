...
/*
============= Update Info =============
- 1.1.9 Marlin 기반                                            ...complete
- Bugfix 적용 완료                                              ...complete
- Manual leveling
- config는 Marlin 내에 있는 정보로 진행                             ...complete
- 설정된 모터 드라이버는 X,Y = TMC2208_STANDALONE, Z,Z1,E0,E1 = A4988로
설정                                                           ...complete
...
// Please choose the name from boards.h that matches your setup
  ...
  //#define PIN_EXP4 a12 // PS_ON_PIN
#endif

// Optional custom name for your RepStrap or other custom machine
// Displayed in the LCD "Ready" message
#define CUSTOM_MACHINE_NAME "CR-10S Tanuki"
...
//Refer to : https://cafe.naver.com/makerfac/48599
